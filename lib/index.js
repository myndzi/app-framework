...
module.exports = function (config, opts) { // jshint ignore: line
    ...
    function reconfigure() {
        ...
        app.lib = function (path) { return require(PATH.join(app.root, 'lib', path)); };
        app.path = function (path) { return PATH.join(app.root, 'app', path); };
    }
    ...
    app.on('loaded', function () {
        app.log.debug('Resolved config:', util.inspect(app.config.get(), { depth: null }));
    });
