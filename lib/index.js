...
module.exports = function (config, opts) { // jshint ignore: line
    ...
    require('./command-line')(app, config);
    ...
    function reconfigure() {
        ...
        // the app root. this should probably be removed somewhere along the line.
    ...
    app.on('listening', function (address, port, env) {
        app.log.info('App "%s" version %s listening on %s:%s in %s mode', app.config.get('app.name'), app.version, address, port, env);
    });
